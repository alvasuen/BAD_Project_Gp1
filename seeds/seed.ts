...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex("categories_songs").insert([
    ...
    { categories_songs_id: 4, songs_id: 4, categories_id: 2 },
    { categories_songs_id: 5, songs_id: 5, categories_id: 2 },
  ]);
  ...
  await knex("playlists_songs").insert([
    ...
    { playlists_songs_id: 3, playlists_id: 1, songs_id: 4 },
    { playlists_songs_id: 4, playlists_id: 1, songs_id: 5 },
    { playlists_songs_id: 5, playlists_id: 1, songs_id: 3 },
    { playlists_songs_id: 6, playlists_id: 2, songs_id: 1 },
    { playlists_songs_id: 7, playlists_id: 2, songs_id: 5 },
    { playlists_songs_id: 8, playlists_id: 3, songs_id: 3 },
    { playlists_songs_id: 9, playlists_id: 3, songs_id: 2 },
  ]);
}
